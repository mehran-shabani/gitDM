...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['resource_type', 'resource_id', 'version'], name='versioning__resourc_9589df_idx'), models.Index(fields=['changed_at'], name='versioning__changed_91d72a_idx')],
