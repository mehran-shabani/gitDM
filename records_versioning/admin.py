...
class RecordVersionAdmin(admin.ModelAdmin):
    list_display = ('resource_type', 'resource_id', 'version', 'changed_by', 'changed_at')
    list_filter = ('resource_type', 'changed_at')
    search_fields = ('resource_type', 'resource_id', 'meta')
    readonly_fields = ('id', 'resource_type', 'resource_id', 'version', 
                      'prev_version', 'snapshot', 'diff', 'meta', 
