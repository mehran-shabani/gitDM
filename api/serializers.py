...
class AISummarySerializer(serializers.ModelSerializer):
    ...
    def get_resource_id(self, obj):
        ...
        این متد مقدار صفت `object_id` از نمونهٔ `obj` را خوانده و به رشته تبدیل می‌کند تا در فیلد سریالایزر `resource_id` قرار گیرد. خروجی برای انواع متداول شناسه (مثلاً UUID یا عدد صحیح) قابل استفاده است و همیشه یک مقدار رشته‌ای بازمی‌گرداند.
        """
